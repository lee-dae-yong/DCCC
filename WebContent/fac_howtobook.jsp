        				...
        				<div class="card-body">
        					...
        					<div style="height:2000px;"><br/>
        						...
        						<div class="card-header">
									<button type="submit" class="btn btn-block btc-dccc" style="width:150px; position:absolute; background:#a9d2b4; top:0; right:0;" onclick="window.location='<%=request.getContextPath()%>/resources/submitFile/첨부_230221DCCC대관_신청서.hwp'"><i class="fa-solid fa-download"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;대관 신청서</button>
									<h3 class="card-title">
								...
								<tbody>
									<tr>
										<th style="width:200px; text-align:center; background:#a9d2b4;">수영장</th>
											<td>수경, 수영모, 수영복 필수</td>
											<td rowspan="10" style="text-align:center;"><br/><br/><br/><br/><br/><br/><br/><br/><br/>음식물 반입 금지</td>
										</tr>
									<tr>
									...
									<tr>
										<th style="width:200px; text-align:center; background:#a9d2b4;">피트니스룸</th>
											<td>ㅇㅀㅇㅀㅇ롱ㄹ</td>
									</tr>
									<tr>
