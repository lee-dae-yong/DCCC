        ...
        <div class="modal-body">
            <h4 class="schedule-list-date">2023년03월 24일(목)$booking.date</h4>      
                        ...
                        <span class="state">신청가능$booking_enable if문</span>
                                          ...
                                          <div class="schedule-list-item ">
                        <span class="date">21:00 ~ 22:00                        </span>
                        <span class="state">신청가능$booking_enable if문</span>
                      </div>
                      		</div>
            ...
            <div class=" gx-10px">
                ...
                <div class="col-6">
                  ...
                  onmouseover="this.style.backgroundColor='#a9d2b4'"  onmouseout="this.style.backgroundColor='#e9e9e9'" style="transition:0.3s; color:black; text-decoration:none;">신청하기</a>
               	</div>
            </div>
        </div>
    </div>
