        		...
        		<div class="row">
        			<div class="col-sm-12">
        				...
        				<div class="card-body text-right pt-0">
        					<button class="btn btn-default btn-original btn-dccc" onclick="location.href='modifyForm.do?no=${photo.pho_no}&searchType=${param.searchType}&keyword=${param.keyword}&perPageNum=&page=${param.page }'">수정</button>
  ...
  <!-- /.content-wrapper -->
    ...
    <script>
    	function remove_go(){
    		...
    		if(ys){
    			location.href='remove.do?no=${photo.pho_no}';
    		}
    	}
    </script>