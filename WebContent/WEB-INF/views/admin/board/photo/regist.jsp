        				...
        				<div class="card-body">
        					...
        					<form id="form" action="regist.do" method="post">
								...
								<div class="row">
									...
									<div class="form-group">
									<label>내용</label>
									<textarea class="form-control regist-textarea" rows="3" placeholder="1000자 이내로 내용을 입력해주세요" style="height:300px; display: none;" maxlength="1000" name="content" id="content"></textarea>
									</div>
									</div>
								</div>
								</form>
