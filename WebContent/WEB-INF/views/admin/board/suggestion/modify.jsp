        			...
        			<div class="col-sm-12">
        				<div class="card-body">
        					...
        					<div class="card-body">
								...
								<input type="hidden" name="adminId" value="${loginAdmin.adm_id}">
        						<div class="row">
									<div class="col-sm-12">
								...
								<div class="row">
									...
									<div class="form-group">
									<label>답변하기</label>
									<div class="form-control regist-div" contenteditable="true" id="replyContent">${suggestion.sug_replyContent }</div>
  ...
  <!-- /.content-wrapper -->
    ...
    <script>
    	function modify_go(){
    		...
    		$('input[name="replyContent"]').val(replyContent);
    		...
    		if($('#replyContent').html().length>1333){
    			alert("내용을 1000자 이하로 입력해주세요!");
    			$('#replyContent').focus();
    			return;
    		}
