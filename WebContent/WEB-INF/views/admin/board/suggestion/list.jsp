									...
									<div class="card-body pt-1">
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr style='font-size:0.85em;cursor:pointer;' onclick="location.href='detail.do?no=${suggestion.sug_no }&searchType=${cri.searchType}&keyword=${cri.keyword}&perPageNum=&page=${cri.page }'">
													...
													<td class="td_limit_size">${suggestion.mem_id }</td>
													<td>							
														<fmt:formatDate value="${suggestion.sug_regDate }" pattern="yyyy-MM-dd"/>
													</td>
													<td class="text-center">${suggestion.sug_viewcnt }</td>
													<td class="text-center">
													<c:if test="${suggestion.sug_replyContent eq null || empty suggestion.sug_replyContent}">답변필요</c:if>
													</td>
												</tr>
												</c:forEach>
											</tbody>
