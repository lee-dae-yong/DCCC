        			...
        			<div class="col-sm-12">
        				<div class="card-body">
							...
							<div class="input-group">
								...
								<fmt:formatDate value="${notice.ntc_startDate }" pattern="yyyy-MM-dd" var="sD"/>
								<fmt:formatDate value="${notice.ntc_endDate }" pattern="yyyy-MM-dd" var="eD"/>
								<input type="date" class="form-control float-right" name="startDate" onchange="javascript:check_startDate();" value="${sD}" id="startDate">
								<div class="input-group-prepend">
								<span class="input-group-text">
								<i class="far fa-calendar-alt"></i>
								</span>
								</div>
								<input type="date" class="form-control float-right" name="endDate" onchange="javascript:check_endDate();" value="${eD}" id="endDate">
							</div>
							
							</div>
								
								<input type="hidden" name="no" value="${notice.ntc_no}">
        						<div class="row">
									<div class="col-sm-12">
									<div class="form-group">
									<label>제목</label>
									<input type="text" class="form-control" placeholder="30자 이내로 제목을 입력해주세요" maxlength="30" value="${notice.ntc_title }" name="title"/>
									</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="form-group">
									<label>내용</label>
									<div class="form-control regist-div" id="content" contenteditable="true">${notice.ntc_content }</div>
