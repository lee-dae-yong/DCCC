                ...
                <div class="card-body">
                  ...
                  <div style="">
                    <div class="card-top row" style="margin:10px 0px;background:white;">
                      ...
                      <button type="button" id="cancleBtn" onclick="location.href='list.do'" class="btn btn-default pull-right btn-original text-center">취소</button>
                    </div>
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form role="form" class="form-horizontal" action="regist.do" method="post">
                                      ...
                                      <div class="mailbox-attachment-info" style="background:#fff;">
                                        <div class="input-group input-group-sm">
                                          ...
                                          <input id="inputFileName" class="form-control" type="text" name="tempPicture" disabled> <span class="input-group-append-sm">
                                            ...
                                            <input type="hidden" name="adm_pic" value=""/>
                                          </span>
                                        </div>
                                      </div>
                                    </div>
                         ...
                         <div class="col-sm-6">
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="adm_id" id="inputId" class="form-control" value="">
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="inputPwd" class="col-sm-2 col-form-label">패스워드</label>
                            <div class="col-sm-10">
                              <input type="password" name="adm_pwd" id="inputPwd" class="form-control" value="">
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="inputName" class="col-sm-2 col-form-label">이름</label>
                            <div class="col-sm-10">
                              <input type="text" name="adm_name" id="inputName" class="form-control" value="">
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="inputPhone" class="col-sm-2 col-form-label">전화번호</label>
                            <div class="col-sm-10">
                              <input type="text" name="adm_phone" id="inputPhone" class="form-control" value="">
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="inputEmail" class="col-sm-2 col-form-label">이메일</label>
                            <div class="col-sm-10">
                              <input type="email" name="adm_email" id="inputPhone" class="form-control" value="">
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="inputDep" class="col-sm-2 col-form-label">소속부서</label>
                            <div class="col-sm-10">
                              <div style="display:flex; align-items:center; ">
									<c:forEach items="${depList }" var="dep">
									
										<span>${dep }</span><input type="radio" name="adm_dep" class="form-control" id="inputDep" value="${dep }">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="adm_rank" id="inputRank" class="form-control" value="">
                            </div>
                          </div>
		...
		if($('input[name="checkUpload"]').val()==1){
		 ...
		 $.ajax({
		        ...
		        success:function(data){
		            ...
		            $('form[role="form"]  input[name="adm_pic"]').val(data);	    	  
		      	 	alert("사진이 업로드 되었습니다.");
		        },
