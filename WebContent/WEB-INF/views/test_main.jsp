        		...
        		<div class="row">
        			<div class="col-sm-12">
        				<div class="card-body aside_menu">
							...
							<button type="button" class="btn btn-default btn-block text-left">대관시설정보</button>
							<button type="button" class="btn btn-default btn-block text-left">대관접수안내</button>
							<button type="button" class="btn btn-default btn-block text-left">시설대관현황</button>
						</div>
        			</div>
        		</div>
        	</div>
