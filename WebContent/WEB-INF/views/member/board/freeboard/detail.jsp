        			...
        			<div class="col-sm-12">
        				<div class="card-body">
										...
										<div class="card-tools">
											<div class="input-group row">
												<div class="d-flex">
													...
													<div class="d-inline-block border-dccc-opacity text-center pl-2 pr-2 min-w-4r">${freeboard.mem_id }</div>
													<div class="d-inline-block page_bg_dccc text-center pr-2 pl-2 w-6r">조회수</div>
													<div class="d-inline-block border-dccc-opacity mr-18p text-center pl-2 pr-2 min-w-4r">${freeboard.brd_viewcnt }</div>
												</div>
											</div>
										</div>
							...
							<div class="time-label" id="repliesDiv">
								<div class="replies-btn">답글 목록</div>							
							</div>
        				...
        				<div class="card-body text-right pt-0">
        						<c:if test="${loginUser.mem_id eq freeboard.mem_id }">
        						<button class="btn btn-default btn-original btn-dccc" onclick="location.href='modifyForm.do?no=${freeboard.brd_no}&searchType=${param.searchType}&keyword=${param.keyword}&perPageNum=&page=${param.page }'">수정</button>
  ...
  <!-- /.content-wrapper -->
    ...
    <script>
    	function remove_go(){
    		...
    		if(ys){
    			location.href='remove.do?no=${freeboard.brd_no}';
    		}
    	}
    </script>
