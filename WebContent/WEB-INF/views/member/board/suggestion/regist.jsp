        			...
        			<div class="col-sm-12">
        				<div class="card-body">
        					...
        					<div class="card-body">
								...
								<input type="hidden" name="writer" value="${loginUser.mem_id}">
        						<div class="row">
									<div class="col-sm-12">
								...
								<div class="row">
									...
									<input class="form-check-input" type="radio" name="rock" checked="checked" value="x">
									<label class="form-check-label">공개</label>
									</div>
									<div class="form-check">
									<input class="form-check-input" type="radio" name="rock" value="o">
