									...
									<div class="card-body pt-1">
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr class="<c:if test="${notice.ntc_startDate le today && today le notice.ntc_endDate }">notice_import_bg</c:if>" style='font-size:0.85em;cursor:pointer;' onclick="location.href='detail.do?from=list&no=${notice.ntc_no}&searchType=${cri.searchType}&keyword=${cri.keyword}&perPageNum=&page=${cri.page }'">
													<td>
													<c:choose>
