									...
									<div class="card-body pt-1">
										<div class="d-flex flex-wrap justify-content-between">
											...
											<c:set value="${fn:substring(p_content,fn:indexOf(p_content,'fileName=')+9,fn:indexOf(p_content,'jpg')+3) }" var="pic_name"/>
												<div class="card" style="width:45%; cursor: pointer;" onclick="location.href='detail.do?from=list&no=${photo.pho_no}&searchType=${cri.searchType}&keyword=${cri.keyword}&perPageNum=&page=${cri.page }'">
